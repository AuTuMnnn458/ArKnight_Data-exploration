...
本文主要通过拆解游戏明日方舟中部分系统的数值，反向推导与构建游戏在人物数值上所使用的数学模型，并研究、学习和讨论该游戏在人物数值上的设计思路。在本文的最后一部分，有作者使用相似模型构造出一个新的RPG游戏的人物数值。本文数据大量参考自[PRTS-玩家自由构筑的明日方舟中文Wiki](https://prts.wiki/w/%E9%A6%96%E9%A1%B5)。本文中有大量excel表格数据，**一般只展示前五行与最后五行数据**，全体数据的excel文件见[这里](https://github.com/AuTuMnnn458/ArKnight_Data-exploration/tree/main/doc)。
## 1 基础介绍
...
### 4.2 法术伤害公式推导与分析
法术伤害公式与物理伤害公式设计思路相同，但是法术伤害无视敌人护甲，限制法术伤害的是敌人的另一属性：法术抵抗。依然是用max函数限制，防止出现干员无视法抗数值>敌人法术抗性所带来的负值，以及百分比无视法抗过高导致的负值。法术攻击的伤害公式为
...
## 5 设计一套RPG人物数值
假设游戏中人物有5种属性：生命值、物理攻击、法术攻击、物理防御、法术防御，有5种职业：武将、弓手、刺客、道士、术士。5种属性分别请设计各职业属性的初始值，并简单说明理由。

    
根据要求有如下的xmind脑图的简单分析。
<center><img src="https://github.com/AuTuMnnn458/ArKnight_Data-exploration/blob/main/pictures/%E4%BA%BA%E7%89%A9%E5%B1%9E%E6%80%A7%E8%AE%BE%E8%AE%A1Xmind.jpg" width = "700px")</center>
...
根据职业定位，初步定下了5个职业的各项属性的初始值和成长量。我们这里假设角色从1级开始，最高升级到51级。1-20级为第一阶段，21-40级为第二阶段，41-51为第三阶段。阶段的不同主要体现在成长量的不同。

| 属性   | 武将   | 弓手   | 刺客  | 道士  | 术士  | 备注        |
|------|------|------|-----|-----|-----|-----------|
| 生命值  | 1    | 2    | 4   | 5   | 3   | 数字越小，数值越高 |
| 物理攻击 | 3    | 2    | 1   | 0   | 0   | 0表示该项数值为0 |
| 魔法攻击 | 0    | 0    | 0   | 1   | 2   |           |
| 物理防御 | 1    | 2    | 3   | 5   | 4   |           |
| 法术防御 | 1    | 4    | 5   | 3   | 2   |           |
|      |      |      |     |     |     |           |
| 初始值  | 武将   | 弓手   | 刺客  | 道士  | 术士  |           |
| 生命值  | 1500 | 1000 | 800 | 700 | 900 |           |
| 物理攻击 | 200  | 300  | 500 | 0   | 0   |           |
| 魔法攻击 | 0    | 0    | 0   | 500 | 300 |           |
| 物理防御 | 200  | 150  | 100 | 70  | 80  |           |
| 法术防御 | 200  | 70   | 80  | 100 | 150 |           |
|      |      |      |     |     |     |           |
| 成长量  | 武将   | 弓手   | 刺客  | 道士  | 术士  | 分别代表三个阶段  |
| 生命值  | 10   | 9    | 7   | 6   | 8   |           |
|      | 8    | 7    | 5   | 4   | 6   |           |
|      | 6    | 5    | 3   | 2   | 4   |           |
| 物理攻击 | 3    | 5    | 8   | 0   | 0   |           |
...
以武将为例子，得到如下数据与图表。剩余数据见[这里](https://github.com/AuTuMnnn458/ArKnight_Data-exploration/blob/main/doc/%E4%BA%BA%E7%89%A9%E5%B1%9E%E6%80%A7%E8%AE%BE%E8%AE%A1%EF%BC%88%E5%8F%AA%E8%AF%BB%EF%BC%89.xlsx)。
| 28 | 1756 | 274  | 0    | 274  | 274  |     | 8  | 2  | 0  | 2  | 2  |
| 29 | 1764 | 276  | 0    | 276  | 276  |     | 8  | 2  | 0  | 2  | 2  |
| 30 | 1772 | 278  | 0    | 278  | 278  |     | 8  | 2  | 0  | 2  | 2  |
| 31 | 1780 | 280  | 0    | 280  | 280  |     | 8  | 2  | 0  | 2  | 2  |
| 32 | 1788 | 282  | 0    | 282  | 282  |     | 8  | 2  | 0  | 2  | 2  |
| 33 | 1796 | 284  | 0    | 284  | 284  |     | 8  | 2  | 0  | 2  | 2  |
| 34 | 1804 | 286  | 0    | 286  | 286  |     | 8  | 2  | 0  | 2  | 2  |
| 35 | 1812 | 288  | 0    | 288  | 288  |     | 8  | 2  | 0  | 2  | 2  |
| 36 | 1820 | 290  | 0    | 290  | 290  |     | 8  | 2  | 0  | 2  | 2  |
| 37 | 1828 | 292  | 0    | 292  | 292  |     | 8  | 2  | 0  | 2  | 2  |
| 38 | 1836 | 294  | 0    | 294  | 294  |     | 8  | 2  | 0  | 2  | 2  |
| 39 | 1844 | 296  | 0    | 296  | 296  |     | 8  | 2  | 0  | 2  | 2  |
| 40 | 1852 | 298  | 0    | 298  | 298  |     | 8  | 2  | 0  | 2  | 2  |
| 41 | 1860 | 300  | 0    | 300  | 300  |     | 6  | 1  | 0  | 2  | 2  |
| 42 | 1866 | 301  | 0    | 302  | 302  |     | 6  | 1  | 0  | 2  | 2  |
| 43 | 1872 | 302  | 0    | 304  | 304  |     | 6  | 1  | 0  | 2  | 2  |
| 44 | 1878 | 303  | 0    | 306  | 306  |     | 6  | 1  | 0  | 2  | 2  |
| 45 | 1884 | 304  | 0    | 308  | 308  |     | 6  | 1  | 0  | 2  | 2  |
| 46 | 1890 | 305  | 0    | 310  | 310  |     | 6  | 1  | 0  | 2  | 2  |
| 47 | 1896 | 306  | 0    | 312  | 312  |     | 6  | 1  | 0  | 2  | 2  |
| 48 | 1902 | 307  | 0    | 314  | 314  |     | 6  | 1  | 0  | 2  | 2  |
| 49 | 1908 | 308  | 0    | 316  | 316  |     | 6  | 1  | 0  | 2  | 2  |
| 50 | 1914 | 309  | 0    | 318  | 318  |     | 6  | 1  | 0  | 2  | 2  |
| 51 | 1920 | 310  | 0    | 320  | 320  |

<table>
    <tr>
        <td ><center><img src="https://github.com/AuTuMnnn458/ArKnight_Data-exploration/blob/main/pictures/%E6%AD%A6%E5%B0%86%E5%B1%9E%E6%80%A7.png" >图1 武将属性 </center></td>
        <td ><center><img src="https://github.com/AuTuMnnn458/ArKnight_Data-exploration/blob/main/pictures/%E6%AD%A6%E5%B0%86%E5%B1%9E%E6%80%A7%E6%88%90%E9%95%BF%E9%87%8F.png" >图2 武将属性成长量 </center></td>
    </tr>
</table>     
    
总结：
* 此例建立的模型比较粗糙，初始值与成长量只是一个相对的数值，仍需要结合游戏的其余系统进行微调。
* 使用分段线性模型建立人物数值模型，有非常好的**稳健性**，不容易出现数值膨胀问题。
