...
## 3 干员属性
### 3.1 干员属性介绍
！[image]（https://github.com/AuTuMnnn458/ArKnight_Data-exploration/blob/main/pictures/%E5%B1%9E%E6%80%A7%E9%9D%A2%E6%9D%BF.png）
一个干员拥有最基础的八项属性值：生命上限、攻击、防御、法术抗性、再部署、部署费用、阻挡数、攻击速度。通过这些属性值可以了解这个干员的基础性能。本部分结合职业，只讨论生命上限、攻击、防御、法术抗性的数据，研究这4项数据与职业的相关性。
